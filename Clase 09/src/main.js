...
app.use('/', routerView)
/*Los routers encargados de renderizar todo lo visual del HTML siempre se cargan con res.render. Además, este router se debe colocar en la ruta raíz y no es necesario que sea precedido por /api como los demás*/
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

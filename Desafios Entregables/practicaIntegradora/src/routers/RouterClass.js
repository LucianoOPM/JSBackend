...
class RouterClass {
    ...
    handlePolicies = policies => (req, res, next) => {
        ...
        const token = authHeader.split(' ')[1]//extrae el bearer desde el header pasado por fetch/POST
        const { user } = jwt.verify(token, SECRET_KEY)//la palabra secreta(en este caso "PalabraJWTSecreta", debería venir en una variable de entorno.)
